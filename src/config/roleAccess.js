...
export const ROLE_ACCESS = {
  ...
  admin: [
    ...
    SCREENS.DOCTOR_SPECIALTY, SCREENS.DOCTOR_QUALIFICATION, SCREENS.APPROVALS,
  ...
  NSM: [
    ...
    SCREENS.DOCTOR_QUALIFICATION, SCREENS.APPROVALS, SCREENS.DIVISION,
  ...
  RBM: [
    ...
    SCREENS.EXPENSE_MANAGEMENT, SCREENS.USER_MANAGEMENT
  ],
  // ABM - Area management
  ABM: [
    SCREENS.DASHBOARD, SCREENS.DOCTORS_CHEMISTS, SCREENS.SALES_PROJECTIONS,
    SCREENS.ACTIVITY_APPROVALS, SCREENS.EXPENSE_MANAGEMENT
  ],
  // TBM - Territory
  TBM: [
    SCREENS.DASHBOARD, SCREENS.DOCTORS_CHEMISTS, SCREENS.SALES_PROJECTIONS,
